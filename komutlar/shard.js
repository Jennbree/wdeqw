...
let i = client.shard.id
    ...
    for(i=0;i<client.shard.count;i++) {
        shardembed.addField(`🔹**Shard ${i}**`, `🏓 **Ping:** ${Math.round(shardinfo.ping[i])}ms\n<a:sag_ok:755937959290732607> **Sunucu:** ${shardinfo.server_count[i]}\n<a:sag_ok:755937959290732607> **Kullanıcı:** ${shardinfo.user_count[i]}\n<a:sag_ok:755937959290732607> **Uptime:** ${moment.duration(shardinfo.uptime[i]).format(`D [Gün] , H [Saat], m [Dakika], s [Saniye]`)} `, true)
    }
